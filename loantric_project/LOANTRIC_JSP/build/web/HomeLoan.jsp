    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h2><span class="glyphicon glyphicon-ok"></span> Eligibility-Check</h2>
        </div>
      ...
      <div class="form-group">
              ...
              <a onclick="window.location.href='#'" type="submit" class="btn btn-success btn-block button2"><span class="glyphicon glyphicon-check"></span> Check Eligibility</a>
          </form>
        </div>
