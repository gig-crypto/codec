...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <p></p>
      <br>
      <button type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal5">Add to Wallet</button>
      <!-- Modal -->
      ...
      <br><br>
      <hr width="100%">
       <a class="btn btn-warning btn-lg button1" href="otherloan-select.jsp"><b>Compare Other Loans</b></a>
