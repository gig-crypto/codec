...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-9">
      ...
      <p></p>
      <br>
      <button type="submit" class="btn btn-warning" data-toggle="modal" data-target="#myModal2">Add to Wallet</button>
      <!-- Modal -->
      ...
      <br><br>
      <hr width="100%">
      <a class="btn btn-warning btn-lg button1" href="agriculturalloan-select.jsp"><b>Compare Agricultural Loans</b></a>
      <br>
    </div>
  </div>
</div>
